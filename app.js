...
//routes
const cyclingroutesRoutes = require('./routes/cyclingroutes');
...
//use routes
app.use('/', userRoutes)
app.use('/cyclingroutes/:id/reviews', reviewRoutes)
app.use('/cyclingroutes', cyclingroutesRoutes);
...
app.use((err, req, res, next) => {
    ...
    res.status(statusCode).render('cyclingroutes/error', { err })
